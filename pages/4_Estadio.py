...
# Garantir capacidade correta pelo nível
...
# Verificar se a melhoria terminou
...
if estadio.get("em_melhorias") and data_inicio:
    try:
        ...
        st.error(f"Erro ao verificar melhorias: {e}")
    ...
    if em_melhorias:
        ...
        if saldo < custo:
            ...
            if st.button(f"📈 Melhorar Estádio para Nível {nivel + 1}"):
                ...
                st.success("🚧 Estádio em obras! Conclusão em 3 dias.")
                st.experimental_rerun()
else:
